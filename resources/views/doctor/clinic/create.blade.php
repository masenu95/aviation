            ...
            <div id="detail-form">
                <div class="form-group row">
                    <div class="col-lg-6 col-md-6">
                      <input type="text" class="form-control" placeholder="Head and neck" name="head" required>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <input type="text" class="form-control" placeholder="ENT system" name="ent" required>
                      </div>
                </div>
                <div class="form-group row">
                    <div class="col-lg-6 col-md-6">
