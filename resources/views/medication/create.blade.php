...
<div class="container">
    ...
    <div class="row form-application">
        ...
        <form action="{{route('medication.store')}}" method="POST" id="form-appli">
                    @if ($errors->any())
                ...
                @csrf
                        ...
                        <div>
                           Do you currently use any medication,including non-prescribed medication?
                        </div><br>
            ...
            <div id="detail-form" style="display: none">
                <div class="form-group row">
                    <div class="col-lg-6 col-md-6">
                      <input type="text" class="form-control" placeholder="Name of medication" name="name">
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <input type="text" class="form-control" placeholder="Date commenced" name="date">
                      </div>
                </div>
                <div class="form-group row">
                    <div class="col-lg-6 col-md-6">
